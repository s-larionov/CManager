...
class CManager_Controller_Router_Xml_Section {
	...
	*/
	...
	public function __construct($xml) {
		if (empty($xml)) {
			throw new CManager_Controller_Router_Xml_Exception('Filename is not set');
		}
	 ...
	 * @throws CManager_Controller_Router_Xml_Exception
	 */
	protected function _getSection(SimpleXMLElement $section, $extendXPath) {
		...
		throw new CManager_Controller_Router_Xml_Exception("Section {$extendXPath} not found");
	}
