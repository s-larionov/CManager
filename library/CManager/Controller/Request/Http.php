 ...
 */
class CManager_Controller_Request_Http extends CManager_Controller_Request_Abstract {
	/**
	 *	пример разбора урла:
	 ...
	 * @throws CManager_Controller_Request_Exception
	 */
	public function getHeader($header) {
		if (empty($header)) {
			throw new CManager_Controller_Request_Exception('An HTTP header name is required');
		}
