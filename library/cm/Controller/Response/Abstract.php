...
abstract class cm_Controller_Response_Abstract {
	/**
	 * Body content
	 * @var array
	 */
	...
	public function getInstance() {
		if (self::$instance === false) {
			self::$instance = new cm_Controller_Response_HTTP;
		}
	...
	public function setHttpResponseCode($code) {
		if (!is_int($code) || (100 > $code) || (599 < $code)) {
			throw new cm_Controller_Response_Exception('Invalid HTTP response code');
		}
	...
	public function canSendHeaders($throw = false) {
		...
		if ($ok && $throw && $this->headersSentThrowsException) {
			throw new cm_Controller_Response_Exception("cannot_send_headers. $file ($line)", $file, $line);
		}
		return !$ok;
	}
