...
class cm_Map_Converter_Mercator {
	/**
	 * @var int
	 */
	...
	public function toLatitudeLongitude($x, $y, $size = null) {
		...
		if (!isset($this->_f[$size])) {
			throw new cm_Exception("Point [{$x}:{$y}] not defined");
		}

		return new cm_Map_GeoPoint(
